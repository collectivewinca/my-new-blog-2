...
const siteMetadata = {
  ...
  socialBanner: `${process.env.BASE_PATH || ''}${process.env.NEXT_PUBLIC_SITE_LOGO || '/static/images/logo-dark.png'}`,
  mastodon: process.env.NEXT_PUBLIC_MASTODON || 'https://mastodon.social/@test',
  email: process.env.NEXT_PUBLIC_EMAIL || 'hello@test.com',
  logo_light: process.env.NEXT_PUBLIC_LOGO_LIGHT || `/static/images/logo-light.png`, 
  logo_dark: process.env.NEXT_PUBLIC_LOGO_DARK || `/static/images/logo-dark.png`,
  favicon: process.env.NEXT_PUBLIC_FAVICON || `/static/images/favicon.ico`,
  ...
  analytics: {
    ...
    umamiAnalytics: {
      ...
      src: process.env.NEXT_PUBLIC_UMAMI_SRC || 'https://analysis.weekend.network/script.js'
    },
    // plausibleAnalytics: {
